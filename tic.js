// called whenever user tab on any box
function myfunc() {
    ...
    // check if player X won or not and then disabled all the other fields
    ...
    // checking for player O starts, if player O won or not
    // and disable all other fields
